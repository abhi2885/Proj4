	...
	$(".case").click(function(){
		...
		if($(".case").length == $(".case:checked").length) {
			...
			$("#selectall").removeAttr("checked");
                    ...
                    <h2 align="center"><font color="red"><%=ServletUtility.getErrorMessage(request)%></font></h2>
                     <h2 align="center"><font color="green"><%=ServletUtility.getSuccessMessage(request)%></font></h2>
